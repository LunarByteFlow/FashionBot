...
export default function SingleBoutiqueDynamic({BoutiqueName}) {
...
// api fetching
useEffect(() => {
  axios.get('http://localhost:1234/api/get-product-by-categoryname?ProductCategory=${ProductCategory}')
